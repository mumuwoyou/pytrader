...
class calculate_Content_based_addressing(AbstractModule):
    ...
    def __init__(self,
        ...
        """
        super(calculate_Content_based_addressing, self).__init__(name=name) # 调用父类初始化
...
class update_Dynamic_memory_allocation(RNNCore):
    ...
    *   Decreased by reading, where usage is decreased after reading from a
    ...
    def __init__(
        ...
        """
        super(update_Dynamic_memory_allocation, self).__init__(name=name)
...
class update_Temporal_memory_linkage(RNNCore):
    ...
    def __init__(self, 
        ...
        Args:
          ...
          name: Name of the module.
        """  
        super(update_Temporal_memory_linkage, self).__init__(name=name)
        self._memory_size = memory_size
...
class DNCoreLSTM(RNNCore):
    ...
    def __init__(
        ...
        super(DNCoreLSTM, self).__init__(name=name) # 调用父类初始化
...
class DNCoreDeepLSTM(RNNCore):
    ...
    def __init__(
        ...
        super(DNCoreDeepLSTM, self).__init__(name=name) # 调用父类初始化
        with self._enter_variable_scope():
