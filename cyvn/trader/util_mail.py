...
class mail_thread(Thread):
    def __init__(self, to_list, subject, msgcontent, attachlist):
        ...
        self.mailfrom = '1168736@qq.com'  #  xxxxx@163.com
        self.mailpwd = 'uczqjztwtwerbjfe' # 密码
        self.lock = maillock
...
def sendmail(subject, msgcontent, attachlist=[], to_list=['mumuwoyou@msn.com']):
