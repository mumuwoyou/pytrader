...
from cyvn.trader.uiQt import QtGui, QtWidgets, QtCore, BASIC_FONT
from cyvn.trader.vtFunction import jsonPathDict
...
class PositionDetailMonitor(BasicMonitor):
 ...
 # ----------------------------------------------------------------------
    def __init__(self, mainEngine, eventEngine, parent=None):
        ...
        d = OrderedDict()
        d['tradeid'] = {'chinese': vtText.TRADE_ID, 'cellType': BasicCell}
        d['symbol'] = {'chinese': vtText.CONTRACT_SYMBOL, 'cellType': BasicCell}
        d['vtSymbol'] = {'chinese':vtText.CONTRACT_NAME, 'cellType': NameCell}
        d['direction'] = {'chinese': vtText.DIRECTION, 'cellType': DirectionCell}
        d['position'] = {'chinese': vtText.POSITION, 'cellType': BasicCell}
        d['openprice'] = {'chinese': vtText.OPENPRICE, 'cellType': BasicCell}
        d['opendate'] = {'chinese': vtText.OPENDATE, 'cellType': BasicCell}
        d['gatewayName'] = {'chinese': vtText.GATEWAY, 'cellType': BasicCell}
        self.setHeaderDict(d)
